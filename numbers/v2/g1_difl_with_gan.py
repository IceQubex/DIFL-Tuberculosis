...
num_of_intermediate_filters = 256
...
domain2_train_dataset = keras.preprocessing.image_dataset_from_directory(domain2_directory, labels='inferred', label_mode='int', color_mode='grayscale', batch_size=16, image_size=(28,28), validation_split=0.2, subset='training', seed=1)
domain2_test_dataset = keras.preprocessing.image_dataset_from_directory(domain2_directory, labels='inferred', label_mode='int', color_mode='grayscale', batch_size=16, image_size=(28,28), validation_split=0.2, subset='validation', seed=1)

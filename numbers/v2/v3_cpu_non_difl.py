...
domain2_train_directory = sys.argv[2]
domain2_test_directory = sys.argv[3]
epochs = int(sys.argv[4])

print(f"\nImporting the necessary datasets..")

# import the first dataset
domain1_train_dataset = keras.preprocessing.image_dataset_from_directory(domain1_directory, labels='inferred', label_mode='int', color_mode='grayscale', batch_size=16, image_size=(28,28), validation_split=0.2, subset='training', seed=99999)
domain1_test_dataset = keras.preprocessing.image_dataset_from_directory(domain1_directory, labels='inferred', label_mode='int', color_mode='grayscale', batch_size=16, image_size=(28,28), validation_split=0.2, subset='validation', seed=99999)

# import the second dataset
domain2_train_dataset = keras.preprocessing.image_dataset_from_directory(domain2_train_directory, labels='inferred', label_mode='int', color_mode='grayscale', batch_size=16, image_size=(28,28), seed=1)
domain2_test_dataset = keras.preprocessing.image_dataset_from_directory(domain2_test_directory, labels='inferred', label_mode='int', color_mode='grayscale', batch_size=16, image_size=(28,28), seed=1)

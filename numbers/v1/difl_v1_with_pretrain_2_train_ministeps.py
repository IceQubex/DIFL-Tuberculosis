...
for epoch in range(epochs):
    ...
    for i in range(len(source_train)):
        ...
        gradients_difl = tape.gradient(classification_loss, difl_model.trainable_weights)
        gradients_classification = tape.gradient(classification_loss, classification_model.trainable_weights)
        del tape

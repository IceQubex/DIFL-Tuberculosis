...
'''
epoch_writer = tf.summary.create_file_writer(f"runs/{r}run/epoch-logs/")
batch_writer = tf.summary.create_file_writer(f"runs/{r}run/batch-logs/")
accuracy_writer = tf.summary.create_file_writer(f"runs/{r}run/accuracy-logs/")
